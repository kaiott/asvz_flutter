...
class Lesson extends HiveObject implements Comparable<Lesson> {
  ...
  factory Lesson.fromJson(Map<String, dynamic> json) {
    return Lesson(
      ...
      instructors: List<String>.from(
        (json["instructors"] as List).map((x) => x["name"] as String),
      ),
...
final Map<String, dynamic> testJson = {
  ...
  "facilities": [
    {
      "facilityId": 203,
      "nameShort": "SC IR",
      "name": "Sport Center Irchel",
      "url": "https://asvz.ch/anlage/45577-sport-center-irchel",
    },
  ],
  ...
  "tlComment": null,
  "language": {
    "id": "117b1004-2137-4b60-8c63-34db3c5c61d6",
    "code": "de",
    "name": "German",
  },
...
final List<Lesson> testLessons = [
  Lesson.fromJson(testJson),
  Lesson.fromJson(testJson1),
  Lesson.fromJson(testJson2),
];
